...
public:
   ...
   int OnTrajectoryVelocity(MM::PropertyBase* pProp, MM::ActionType eAct); //trying to get TV for focus axis
   int OnTrajectoryAcceleration(MM::PropertyBase* pProp, MM::ActionType eAct); //trying to get TA for focus axis
